export const drishtiSections = [
  {
    id: "head-yaw-limits",
    eyebrow: "Why not head-yaw alone",
  ...
  },
  {
    ...
    eyebrow: "Attention fingerprints",
