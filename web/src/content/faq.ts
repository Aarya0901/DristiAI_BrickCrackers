...
export const faqItems: FaqItem[] = [
  {
    ...
    answer:
      "No. VIGIL produces a behavioural review request: seat, behaviour, evidence, confidence, and uncertainty. A human invigilator interprets the evidence and makes any judgement. VIGIL never outputs a verdict or a risk score.",
  ...
  },
  {
    ...
    answer:
      "No. VIGIL does not claim pupil-level gaze. It estimates coarse head direction, torso orientation, and scene-level attention mass at the resolution typical CCTV actually supports — always described as an attention estimate, never as proof of where a student's eyes were pointed.",
    categories: ["capability", "limitations"],
  },
  {
    id: "occlusion",
