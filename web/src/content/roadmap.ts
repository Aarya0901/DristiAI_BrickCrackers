...
export const stageStatusLabels: Record<BuildStage["status"], string> = {
  active: "Active",
  next: "Next",
  planned: "Planned",
  roadmap: "Roadmap",
...
export const validationGates: ValidationGate[] = [
  {
    ...
    fallback:
      "Ship head-direction-only signals and cut the learned attention estimator if it doesn't generalise.",
  },
  {
    ...
    risks:
      "Real institutional camera placement is rarely ideal; back-row visibility is a hard physical constraint.",
    fallback:
      "Recommend camera-position changes before enabling live alerts in affected rooms; keep shadow mode running.",
  },
];
